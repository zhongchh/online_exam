...
<%
    ...
    ResultSet rs = userdao.availableCourse(session.getAttribute("username").toString()," ");
%>
<div class="x-nav">
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr >
            ...
            <td class="td-manage">
                <button class="layui-btn layui-btn layui-btn-xs" onclick="x_admin_show('添加课程','delete_choose.jsp?param=<%=rs.getString("cid")%>');">
