...
;(function ($, window, document, undefined) {
    ...
    $.idealforms.errors = {
        ...
        phone: 'Must be a valid phone number. <em>(e.g. 123-4567-8900)</em>',
        zip: 'Must be a valid zip code. <em>(e.g. 650500)</em>',
...
// Get LESS variables
    ...
    $.extend(IdealForms.prototype, {
        ...
        _setDatepicker: function () {
            ...
            if (jQuery.ui && $datepicker.length) {
                ...
                $datepicker.each(function () {
                    ...
                    var format = data ? data.replace('yyyy', 'yy') : 'yy-mm-dd'
        ...
        _validate: function ($input, e) {
            ...
            if (e.type === 'keyup' && value === oldValue) {
                return false
            }
