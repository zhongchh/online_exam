...
<div class="x-body" style="margin: 0 auto">
    <form class="layui-form" method="post" action="5do_question_edit_otherQuestion.jsp">
        <input name="file" value="/Users/songbin/Develop/IdeaProjects/OnlineExamSystem/xml/teacher/宋斌/questionBank/基于Java的XML及其相关技术/判断.xml" type="hidden">
        ...
        <div class="layui-form-item">
            ...
            <%
                ...
                //从数据库取值
                ArrayList<Question> questionArrayList = readXml.getSingleSelection("/Users/songbin/Develop/IdeaProjects/OnlineExamSystem/xml/teacher/宋斌/questionBank/基于Java的XML及其相关技术/判断.xml");
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="trueAnswer" value="T" title="T">
                <input type="radio" name="trueAnswer" value="F" title="F">
            </div>
        </div>
        <div class="layui-form-item">
