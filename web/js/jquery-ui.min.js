...
(function (e, t) {
    ...
    e.effects = {effect: {}}, function (t, n) {
        ...
        e.extend(e.effects, {
            ...
            effect: function (t, r, s, o) {
                ...
                var u = i.apply(this, arguments), a = u.mode, f = u.queue, l = e.effects.effect[u.effect],
    ...
    e.widget("ui.button", {
        ...
        _create: function () {
            ...
            var t = this, u = this.options, a = this.type === "checkbox" || this.type === "radio",
                c = "ui-state-hover" + (a ? "" : " ui-state-active"), h = "ui-state-focus";
    ...
    e.widget("ui.dialog", {
        ...
        _create: function () {
            ...
            var t = this, r = this.options, i = r.title || "&#160;",
    ...
    e.effects.effect.puff = function (t, n) {
        var r = e(this), i = e.effects.setMode(r, t.mode || "hide"), s = i === "hide",
            o = parseInt(t.percent, 10) || 150, u = o / 100, a = {height: r.height(), width: r.width()};
        e.extend(t, {
            effect: "scale",
            queue: !1,
            fade: !0,
        ...
        var r = e(this), i = ["position", "top", "bottom", "left", "right", "width", "height", "overflow", "opacity"],
            s = ["position", "top", "bottom", "left", "right", "overflow", "opacity"],
            o = ["width", "height", "overflow"], u = ["fontSize"],
            a = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
            f = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"],
            l = e.effects.setMode(r, t.mode || "effect"), c = t.restore || l !== "effect", h = t.scale || "both",
            p = t.origin || ["middle", "center"], d, v, m, g = r.css("position");
        l === "show" && r.show(), d = {
            height: r.height(),
            width: r.width(),
            ...
            from: {y: r.from.height / d.height, x: r.from.width / d.width},
    ...
    e.widget("ui.slider", e.ui.mouse, {
        ...
        _create: function () {
            var t, r = this.options,
                ...
                o = r.values && r.values.length || 1, u = [];
