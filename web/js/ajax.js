...
function ajax(id) {
    ...
    var fatherId = idField.parentNode.parentNode.parentNode.parentNode.childNodes;
    var question = fatherId.getElementsByTagName("div")[0].value;
    //访问validate.do这个servlet，同时把获取的表单内容idField加入url字符串，以便传递给validate.do
    var url = "ajax.jsp?value=" + encodeURI(idField.value) + "&question=" + encodeURI(question);
