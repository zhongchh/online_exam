...
<div class="x-body" style="margin: 0 auto">
    <form class="layui-form" method="post" action="5do_question_add_otherQuestion.jsp">
        ...
        <input name="file" value="/Users/songbin/Develop/IdeaProjects/OnlineExamSystem/xml/teacher/宋斌/questionBank/基于Java的XML及其相关技术/简答.xml" type="hidden">
        <input name="type" value="shortAnswerQuestion" type="hidden">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="trueAnswer" placeholder="请输入问题" class="layui-textarea"></textarea>
            </div>
        </div>
