    ...
    <form class="layui-form" method="post" action="5do_question_edit_otherQuestion.jsp">
        <div class="layui-form-item">
            ...
            <%
                ...
                //从数据库取值
                ArrayList<Question> questionArrayList = readXml.getSingleSelection("/Users/songbin/Develop/IdeaProjects/OnlineExamSystem/xml/teacher/宋斌/questionBank/基于Java的XML及其相关技术/填空.xml");
